...
public class Homepage extends BasePage {
	...
	// locator variable in the home page
	...
	// constructor
	// when I create an object based on this Homepage class, I have to provide a
	// WebDriver instance or an object.
	// then the constructor use it to update the local 'driver' variable with the
	// object I have passed
	// while creating an object of this Homepage class.
	public Homepage() throws IOException {
		super();
	}

	// create public methods to get the value of these locator variables
